...
<head>
    ...
    <title>Payroll: {{ Carbon\Carbon::parse($payroll->start_date)->format('m-d-Y') }} to
...
<body lang=ES-PA style='word-wrap:break-word'>
    ...
    <div class=WordSection1>
            ...
            <div class=WordSection1>
                <p class=MsoNormal align=center style='text-align:center'><b>
                        <span style='font-size:12.0pt;line-height:107%;font-family:"Arial",sans-serif'>
                            Payroll: {{ Carbon\Carbon::parse($payroll->start_date)->format('m-d-Y') }} to
                        ...
                        <td width="47%" valign=top
                            ...
                            <p class=MsoNormal align=right
                                style='margin-bottom:0cm;text-align:right; line-height:normal'><b><i><span
                                            style='font-family:"Arial",sans-serif; color:black'>TOTAL</span></i></b></p>
                        </td>
                        <td width="16%"
        ...
        <p class=MsoNormal align=center style='text-align:center'><b><span
                    style='font-size:12.0pt;line-height:107%;font-family:"Arial",sans-serif'>Coordinator</span></b></p>
            ...
            <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width="100%"
                ...
                <tr style='height:21.4pt'>
                    <td width="100%" colspan=4
                        ...
                        <p class=MsoNormal align=center
                            style='margin-bottom:0cm;text-align:center; line-height:normal'>
                            <i><span style='font-size:12.0pt;font-family:"Arial",sans-serif'>Payment for interpreting
                                    Services</span></i>
                        </p>
                    </td>
                </tr>
        ...
        <p class=MsoNormal align=center style='text-align:center'><b><span
                    style='font-size:12.0pt;line-height:107%;font-family:"Arial",sans-serif'>Miscellaneous</span></b></p>
